...
public class AdminDonorAdapter extends RecyclerView.Adapter<AdminDonorAdapter. DonorViewHolder> {
    ...
    public AdminDonorAdapter(OnDonorClickListener listener) {
    ...
    class DonorViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageButton btnCall, btnEdit, btnDelete;
        ...
        public void bind(User donor) {
            ...
            if (donor.getLastDonation() != null && !donor.getLastDonation().isEmpty()) {
                ...
                tvLastDonation.setVisibility(View.GONE);
            }
            ...
            btnEdit. setOnClickListener(v -> {
                if (listener != null) listener.onEditClick(donor);
            });
